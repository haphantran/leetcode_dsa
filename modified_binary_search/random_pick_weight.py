...
def test_random_pick_weight():
    """Test cases for random pick with weight function."""
    test_inputs = [
        # Add test cases here
    ...
    for i, (input_data, expected_output) in enumerate(test_inputs):
        result = random_pick_weight(input_data)
