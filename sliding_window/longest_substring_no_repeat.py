...
def longest_substring_no_repeat():
    """
...
def test_longest_substring_no_repeat():
    """Test cases for longest substring without repeating characters function."""
    test_inputs = [
        # Add test cases here
    ...
    for i, (input_data, expected_output) in enumerate(test_inputs):
        result = longest_substring_no_repeat(input_data)
...
if __name__ == "__main__":
    test_longest_substring_no_repeat()
