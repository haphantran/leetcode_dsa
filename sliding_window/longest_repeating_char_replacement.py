...
def longest_repeating_char_replacement():
    """
...
def test_longest_repeating_char_replacement():
    """Test cases for longest repeating character replacement function."""
    test_inputs = [
        # Add test cases here
    ...
    for i, (input_data, expected_output) in enumerate(test_inputs):
        result = longest_repeating_char_replacement(input_data)
