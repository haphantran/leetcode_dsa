...
def test_count_number_text_words():
    """Test cases for number of squareful arrays function."""
    test_inputs = [
        # Add test cases here
    ...
    for i, (input_data, expected_output) in enumerate(test_inputs):
        result = count_number_text_words(input_data)
